...
<?php 
			...
			foreach($this->question as $question) {
				...
				<li class="wpProQuiz_listItem" style="display: none;">
					...
					<div class="wpProQuiz_question" style="margin: 10px 0px 0px 0px;">
						...
						<?php } ?>
						<ul class="wpProQuiz_questionList <?php print 'wpProQuiz_question_type_'.sanitize_html_class($question->getAnswerType())?>" data-question_id="<?php echo $question->getId(); ?>" data-type="<?php echo $question->getAnswerType(); ?>">
						<?php
							$answer_index = 0;
	...
	// 									$catPoints[$question->getCategoryId()] += $question->getPoints();
					...
					<?php if(!$this->quiz->isHideAnswerMessageBox()) { ?>
						<div class="wpProQuiz_response <?php print 'wpProQuiz_question_type_'.sanitize_html_class($question->getAnswerType())?>" style="display: none;">
